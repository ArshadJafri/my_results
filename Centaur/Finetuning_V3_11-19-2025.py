...
import os
# Setting environment variables for DeepSpeed compatibility
...
def main(model_args, data_args, training_args):
    ...
    trainer = Trainer(
        ...
        eval_dataset=eval_dataset, # Evaluation dataset is included here
...
training_args = TrainingArguments(
    ...
    include_input_for_metrics=True,
...
# --- PLOTTING SECTION: MODIFIED TO INCLUDE EVALUATION LOSS ---
...
if not os.path.exists(output_dir):
    ...
    if os.path.exists(trainer_state_path):
        try:
            ...
            # Filter for both training loss and evaluation loss entries
            ...
            if train_losses or eval_losses:
                ...
                if train_losses:
                    plt.plot(train_steps, train_losses, marker='o', linestyle='-', color='b', label='Training Loss')
                ...
                print(f"Saved combined loss plot to {plot_filename}")
            else:
